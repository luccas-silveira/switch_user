var SwitchUser=(()=>{var b=Object.defineProperty;var Z=Object.getOwnPropertyDescriptor;var X=Object.getOwnPropertyNames;var ee=Object.prototype.hasOwnProperty;var te=(o,e)=>{for(var t in e)b(o,t,{get:e[t],enumerable:!0})},oe=(o,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of X(e))!ee.call(o,r)&&r!==t&&b(o,r,{get:()=>e[r],enumerable:!(n=Z(e,r))||n.enumerable});return o};var ne=o=>oe(b({},"__esModule",{value:!0}),o);var ye={};te(ye,{default:()=>xe,getDropdown:()=>k,init:()=>he,start:()=>pe,startApp:()=>d});var re={namespace:"ui-injector",version:"1.0.0",debug:!1,cssIsolation:"shadow-dom",mountTarget:null,mountPosition:"body-end",zIndexBase:999e3,domTimeout:5e3,retryInterval:100,maxRetries:50,observeMutations:!0,hooks:{onBeforeInit:null,onAfterInit:null,onBeforeMount:null,onAfterMount:null,onBeforeDestroy:null,onAfterDestroy:null,onError:null}},D={...re};function c(){return{...D}}function u(){return D.namespace}function E(o,e={}){let t=c(),{timeout:n=t.domTimeout,interval:r=t.retryInterval,parent:a=document}=e;return new Promise((s,Y)=>{let j=a.querySelector(o);if(j){s(j);return}let J=Date.now(),T=setInterval(()=>{let A=a.querySelector(o);if(A){clearInterval(T),s(A);return}Date.now()-J>=n&&(clearInterval(T),Y(new Error(`Timeout: elemento "${o}" n\xE3o encontrado`)))},r)})}function p(o,e){let t=u(),n=new Date().toISOString().split("T")[1].split(".")[0];return`[${t}][${n}][${o}] ${e}`}var ie={debug(o,...e){c().debug&&console.log(p("DEBUG",o),...e)},info(o,...e){console.info(p("INFO",o),...e)},warn(o,...e){console.warn(p("WARN",o),...e)},error(o,...e){console.error(p("ERROR",o),...e);let t=c();if(t.hooks.onError)try{t.hooks.onError(new Error(o),e)}catch(n){console.error(p("ERROR","Erro no hook onError"),n)}},group(o,e){if(c().debug){console.groupCollapsed(p("GROUP",o));try{e()}finally{console.groupEnd()}}}},i=ie;var v=class{constructor(){this.listeners=new Map}_prefixEvent(e){return`${u()}:${e}`}on(e,t){let n=this._prefixEvent(e);return this.listeners.has(n)||this.listeners.set(n,new Set),this.listeners.get(n).add(t),i.debug(`Listener registrado para evento: ${e}`),()=>this.off(e,t)}once(e,t){let n=(...r)=>{this.off(e,n),t(...r)};return this.on(e,n)}off(e,t){let n=this._prefixEvent(e),r=this.listeners.get(n);r&&(r.delete(t),r.size===0&&this.listeners.delete(n),i.debug(`Listener removido do evento: ${e}`))}emit(e,t){let n=this._prefixEvent(e),r=this.listeners.get(n);i.debug(`Evento emitido: ${e}`,t),r&&r.forEach(a=>{try{a(t)}catch(s){i.error(`Erro ao executar listener do evento ${e}:`,s)}})}clear(e){if(e){let t=this._prefixEvent(e);this.listeners.delete(t),i.debug(`Listeners limpos do evento: ${e}`)}else this.listeners.clear(),i.debug("Todos os listeners foram limpos")}},se=new v;var z=`
  :host {
    /* Cores prim\xE1rias */
...
${M}`}var I=class{constructor(){this.styleSheets=new Map,this.shadowRoot=null}setShadowRoot(e){this.shadowRoot=e}_getStyleId(e){return`${u()}-style-${e}`}_prefixSelectors(e){let t=u();return e.replace(/([^\r\n,{}]+)(,(?=[^}]*{)|\s*{)/g,(n,r,a)=>{let s=r.trim();return s.startsWith("@")||s.startsWith(":root")||s.startsWith(":host")?n:`.${t} ${s}${a}`})}inject(e,t){let n=c(),r=this._getStyleId(e);this.remove(e);let a=t;n.cssIsolation==="prefixed"&&!this.shadowRoot&&(a=this._prefixSelectors(t));let s=document.createElement("style");return s.id=r,s.textContent=a,this.shadowRoot?this.shadowRoot.appendChild(s):document.head.appendChild(s),this.styleSheets.set(e,s),i.debug(`Estilo injetado: ${e}`),s}remove(e){let t=this.styleSheets.get(e);t&&t.parentNode&&(t.parentNode.removeChild(t),this.styleSheets.delete(e),i.debug(`Estilo removido: ${e}`))}injectBaseStyles(){this.inject("base",_())}clear(){this.styleSheets.forEach((e,t)=>this.remove(t)),i.debug("Todos os estilos foram removidos")}has(e){return this.styleSheets.has(e)}},B=new I;var ae="citQs4acsN1StzOEDuvj",f=class{constructor(e={}){this.id="user-dropdown-"+Math.random().toString(36).substring(2,9),this.targetSelector=e.targetSelector||"#OpportunityOwner",this.allowedLocationId=e.allowedLocationId||ae,this.originalElement=null,this.element=null,this._mounted=!1,this.state={isOpen:!1,users:e.users||[],selectedUser:null},this._eventListeners=[],this._handleToggle=this._handleToggle.bind(this),this._handleSelect=this._handleSelect.bind(this),this._handleClickOutside=this._handleClickOutside.bind(this)}on(e,t){this._eventListeners.push({event:e,callback:t})}emit(e,t){this._eventListeners.filter(n=>n.event===e).forEach(n=>n.callback(t))}setState(e){this.state={...this.state,...e},this._mounted&&this._rerender()}setUsers(e){this.setState({users:e||[]})}_getStyles(){return`
    ...
    `}_createElement(){let e=document.createElement("div");return e.innerHTML=this._render(),e}_rerender(){if(!this.element||!this.element.parentNode)return;let e=this.element.parentNode,t=this._createElement();e.replaceChild(t,this.element),this.element=t,this._bindEvents(),i.debug(`Componente re-renderizado: ${this.id}`)}_getLocationIdFromUrl(){let t=window.location.pathname.match(/\/location\/([^\/]+)/);return t?t[1]:null}_isAllowedLocation(){return this._getLocationIdFromUrl()===this.allowedLocationId}_handleToggle(e){e.stopPropagation(),e.preventDefault(),this.setState({isOpen:!this.state.isOpen})}_handleSelect(e){let t=e.target.closest(".ud-item");if(!t)return;let n=t.dataset.userId,r=this.state.users.find(a=>a.id===n);r&&(this.setState({selectedUser:r,isOpen:!1}),this.emit("user:selected",r),i.debug(`Usu\xE1rio selecionado: ${r.name}`))}_handleClickOutside(e){this.element&&!this.element.contains(e.target)&&this.state.isOpen&&this.setState({isOpen:!1})}_bindEvents(){if(!this.element)return;let e=this.element.querySelector(".ud-trigger"),t=this.element.querySelector(".ud-list");e&&e.addEventListener("click",this._handleToggle),t&&t.addEventListener("click",this._handleSelect),document.removeEventListener("click",this._handleClickOutside),document.addEventListener("click",this._handleClickOutside)}_unbindEvents(){document.removeEventListener("click",this._handleClickOutside)}async mountReplacing(){try{if(!this._isAllowedLocation()){let e=this._getLocationIdFromUrl();return i.debug(`UserDropdown n\xE3o exibido: locationId atual (${e}) diferente do permitido (${this.allowedLocationId})`),null}return this.originalElement=await E(this.targetSelector,{timeout:1e4}),this.originalElement?(this.originalElement.style.display="none",this.element=this._createElement(),this.originalElement.parentNode.insertBefore(this.element,this.originalElement.nextSibling),this._mounted=!0,this._bindEvents(),i.debug(`UserDropdown montado substituindo: ${this.targetSelector}`),this.element):(i.error(`Elemento n\xE3o encontrado: ${this.targetSelector}`),null)}catch(e){return i.error(`Erro ao montar UserDropdown: ${e.message}`),null}}unmount(){this._unbindEvents(),this.element&&this.element.parentNode&&this.element.parentNode.removeChild(this.element),this.originalElement&&(this.originalElement.style.display="",i.debug("Elemento original restaurado")),this._mounted=!1}};var S={baseUrl:"https://services.leadconnectorhq.com",token:"pit-301590c6-a6cb-47d5-a7f4-bc5c4f5c22d4",version:"2021-07-28"};function le(){return{Accept:"application/json","Content-Type":"application/json",Authorization:`Bearer ${S.token}`,Version:S.version}}async function P(o){let e=`${S.baseUrl}/users/?locationId=${o}`,t=await fetch(e,{method:"GET",headers:le()});if(!t.ok)throw new Error(`Erro ao buscar usu\xE1rios: ${t.status}`);return(await t.json()).users||[]}function O(){let e=window.location.pathname.match(/\/location\/([^\/]+)/);return e?e[1]:null}function q(){let e=window.location.pathname.match(/\/opportunities\/list\/([^\/\?]+)/);return e?e[1]:null}var L="ui-injector:route-change",W="__uiInjectorHistoryPatched",w=new Set,H=!1,C="",x=null;function g(o){let e=window.location.href;e!==C&&(C=e,w.forEach(t=>t({url:e,reason:o})))}function de(){if(window[W])return;let o=history.pushState,e=history.replaceState;history.pushState=function(...t){let n=o.apply(this,t);return window.dispatchEvent(new Event(L)),n},history.replaceState=function(...t){let n=e.apply(this,t);return window.dispatchEvent(new Event(L)),n},window[W]=!0}function ce({pollInterval:o}){H||(H=!0,C=window.location.href,de(),window.addEventListener(L,()=>g("history")),window.addEventListener("popstate",()=>g("popstate")),window.addEventListener("hashchange",()=>g("hashchange")),o>0&&(x=window.setInterval(()=>g("poll"),o)))}function V(o,e={}){return typeof window>"u"?()=>{}:(w.add(o),ce({pollInterval:typeof e.pollInterval=="number"?e.pollInterval:1e3}),()=>{w.delete(o),w.size===0&&x&&(clearInterval(x),x=null)})}var y="citQs4acsN1StzOEDuvj",Q='[data-component-id^="user-dropdown"]',h=null,$=null,R=!1,U=!1,m=null,G=!1;function l(o,e){console.log(`[SwitchUser] ${o}`,e||"")}function K(){document.querySelectorAll(Q).forEach(t=>t.parentNode?.removeChild(t));let e=document.querySelector("#OpportunityOwner");e&&(e.style.display="")}function ue(){return!!document.querySelector(Q)}async function d(){try{l("Iniciando...");let o=O();if(o!==y)return l("Location n\xE3o permitida:",o),null;l("Location OK:",o),K(),l("Buscando usu\xE1rios...");let e=await P(y);if(l("Usu\xE1rios carregados:",e.length),!e||e.length===0)return l("ERRO: Nenhum usu\xE1rio retornado da API"),null;let t=0,n=document.querySelector("#OpportunityOwner");for(;!n&&t<50;)await new Promise(r=>setTimeout(r,200)),n=document.querySelector("#OpportunityOwner"),t++;return n?(l("Criando dropdown com",e.length,"usu\xE1rios"),h=new f({users:e,targetSelector:"#OpportunityOwner",allowedLocationId:y}),h.on("user:selected",r=>{l("Selecionado:",r.name)}),await h.mountReplacing(),l("Pronto! Dropdown montado com",h.state.users.length,"usu\xE1rios"),{dropdown:h,users:e}):(l("ERRO: Elemento #OpportunityOwner n\xE3o encontrado"),null)}catch(o){throw l("ERRO:",o.message),console.error(o),o}}var pe=d,he=d;async function me(){R=!0;try{await d()}catch(o){l("ERRO ao reinjetar:",o.message)}finally{R=!1,U&&(U=!1,N())}}function fe(){if(m&&(clearTimeout(m),m=null),R){U=!0;return}me()}function N(){let o=O(),e=q();if(o!==y||!e){K(),$=e;return}let t=e!==$;t&&($=e),(t||!ue())&&fe()}function ge(){m||(m=setTimeout(()=>{m=null,N()},1e3))}function we(){G||(G=!0,V(()=>{N()},{pollInterval:1e3}))}function k(){return h}typeof window<"u"&&(window.SwitchUser={start:d,init:d,startApp:d,getDropdown:k},we(),ge());var xe={startApp:d,start:d,init:d,getDropdown:k};return ne(ye);})();
