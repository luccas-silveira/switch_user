var UIInjector=(()=>{var L=Object.defineProperty;var re=Object.getOwnPropertyDescriptor;var ie=Object.getOwnPropertyNames;var se=Object.prototype.hasOwnProperty;var ae=(o,e)=>{for(var t in e)L(o,t,{get:e[t],enumerable:!0})},le=(o,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of ie(e))!se.call(o,i)&&i!==t&&L(o,i,{get:()=>e[i],enumerable:!(n=re(e,i))||n.enumerable});return o};var ce=o=>le(L({},"__esModule",{value:!0}),o);var ye={};ae(ye,{default:()=>ve,getDropdown:()=>W,init:()=>w,start:()=>w});var de={namespace:"ui-injector",version:"1.0.0",debug:!1,cssIsolation:"shadow-dom",mountTarget:null,mountPosition:"body-end",zIndexBase:999e3,domTimeout:5e3,retryInterval:100,maxRetries:50,observeMutations:!0,hooks:{onBeforeInit:null,onAfterInit:null,onBeforeMount:null,onAfterMount:null,onBeforeDestroy:null,onAfterDestroy:null,onError:null}},v={...de};function c(){return{...v}}function O(o){return v={...v,...o,hooks:{...v.hooks,...o.hooks||{}}},c()}function u(){return v.namespace}function z(o,e={}){let t=c(),{timeout:n=t.domTimeout,interval:i=t.retryInterval,parent:r=document}=e;return new Promise((a,d)=>{let I=r.querySelector(o);if(I){a(I);return}let ne=Date.now(),H=setInterval(()=>{let G=r.querySelector(o);if(G){clearInterval(H),a(G);return}Date.now()-ne>=n&&(clearInterval(H),d(new Error(`Timeout: elemento "${o}" n\xE3o encontrado`)))},i)})}function V(){return new Promise(o=>{document.readyState==="loading"?document.addEventListener("DOMContentLoaded",o,{once:!0}):o()})}function $(o,e={},t=[]){let n=document.createElement(o);return Object.entries(e).forEach(([r,a])=>{if(r==="className")n.className=a;else if(r==="style"&&typeof a=="object")Object.assign(n.style,a);else if(r.startsWith("on")&&typeof a=="function"){let d=r.slice(2).toLowerCase();n.addEventListener(d,a)}else r==="dataset"&&typeof a=="object"?Object.entries(a).forEach(([d,I])=>{n.dataset[d]=I}):n.setAttribute(r,a)}),(Array.isArray(t)?t:[t]).forEach(r=>{typeof r=="string"?n.appendChild(document.createTextNode(r)):r instanceof Node&&n.appendChild(r)}),n}function m(o,e){let t=u(),n=new Date().toISOString().split("T")[1].split(".")[0];return`[${t}][${n}][${o}] ${e}`}var l={debug(o,...e){c().debug&&console.log(m("DEBUG",o),...e)},info(o,...e){console.info(m("INFO",o),...e)},warn(o,...e){console.warn(m("WARN",o),...e)},error(o,...e){console.error(m("ERROR",o),...e);let t=c();if(t.hooks.onError)try{t.hooks.onError(new Error(o),e)}catch(n){console.error(m("ERROR","Erro no hook onError"),n)}},group(o,e){if(c().debug){console.groupCollapsed(m("GROUP",o));try{e()}finally{console.groupEnd()}}}},s=l;var R=class{constructor(){this.listeners=new Map}_prefixEvent(e){return`${u()}:${e}`}on(e,t){let n=this._prefixEvent(e);return this.listeners.has(n)||this.listeners.set(n,new Set),this.listeners.get(n).add(t),s.debug(`Listener registrado para evento: ${e}`),()=>this.off(e,t)}once(e,t){let n=(...i)=>{this.off(e,n),t(...i)};return this.on(e,n)}off(e,t){let n=this._prefixEvent(e),i=this.listeners.get(n);i&&(i.delete(t),i.size===0&&this.listeners.delete(n),s.debug(`Listener removido do evento: ${e}`))}emit(e,t){let n=this._prefixEvent(e),i=this.listeners.get(n);s.debug(`Evento emitido: ${e}`,t),i&&i.forEach(r=>{try{r(t)}catch(a){s.error(`Erro ao executar listener do evento ${e}:`,a)}})}clear(e){if(e){let t=this._prefixEvent(e);this.listeners.delete(t),s.debug(`Listeners limpos do evento: ${e}`)}else this.listeners.clear(),s.debug("Todos os listeners foram limpos")}},p=new R;var Q=`
  :host {
    /* Cores prim\xE1rias */
...
`;function k(){return`${Q}
${Z}`}var A=class{constructor(){this.styleSheets=new Map,this.shadowRoot=null}setShadowRoot(e){this.shadowRoot=e}_getStyleId(e){return`${u()}-style-${e}`}_prefixSelectors(e){let t=u();return e.replace(/([^\r\n,{}]+)(,(?=[^}]*{)|\s*{)/g,(n,i,r)=>{let a=i.trim();return a.startsWith("@")||a.startsWith(":root")||a.startsWith(":host")?n:`.${t} ${a}${r}`})}inject(e,t){let n=c(),i=this._getStyleId(e);this.remove(e);let r=t;n.cssIsolation==="prefixed"&&!this.shadowRoot&&(r=this._prefixSelectors(t));let a=document.createElement("style");return a.id=i,a.textContent=r,this.shadowRoot?this.shadowRoot.appendChild(a):document.head.appendChild(a),this.styleSheets.set(e,a),s.debug(`Estilo injetado: ${e}`),a}remove(e){let t=this.styleSheets.get(e);t&&t.parentNode&&(t.parentNode.removeChild(t),this.styleSheets.delete(e),s.debug(`Estilo removido: ${e}`))}injectBaseStyles(){this.inject("base",k())}clear(){this.styleSheets.forEach((e,t)=>this.remove(t)),s.debug("Todos os estilos foram removidos")}has(e){return this.styleSheets.has(e)}},f=new A;var ue="citQs4acsN1StzOEDuvj",y=class{constructor(e={}){this.id="user-dropdown-"+Math.random().toString(36).substring(2,9),this.targetSelector=e.targetSelector||"#OpportunityOwner",this.allowedLocationId=e.allowedLocationId||ue,this.originalElement=null,this.element=null,this.menuElement=null,this._mounted=!1,this.state={isOpen:!1,users:e.users||[],selectedUser:null},this._eventListeners=[],this._justToggled=!1,this._handleToggle=this._handleToggle.bind(this),this._handleSelect=this._handleSelect.bind(this),this._handleClickOutside=this._handleClickOutside.bind(this),this._handleClear=this._handleClear.bind(this)}on(e,t){this._eventListeners.push({event:e,callback:t})}emit(e,t){this._eventListeners.filter(n=>n.event===e).forEach(n=>n.callback(t))}setState(e){this.state={...this.state,...e},this._mounted&&this._rerender()}setUsers(e){this.setState({users:e||[]})}_getArrowIcon(){return`<svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    `;return`
      <div class="hr-select ui-select" data-component-id="${this.id}" style="position: relative;">
        <div class="${i}" style="${this._getSelectionStyles()}">
    ...
    `}_renderMenu(){let{isOpen:e,users:t,selectedUser:n}=this.state;if(!e)return"";let i=t.length>0?t.map(r=>`
          <div class="hr-base-select-option hr-base-select-option--show-checkmark${n?.id===r.id?" hr-base-select-option--pending":""}" data-user-id="${r.id}">
            <div class="hr-base-select-option__content">
              <div style="font-weight: 400; font-size: 14px; line-height: 20px; padding: 8px 0px; width: 100%; box-sizing: border-box; display: flex; align-items: center; flex-direction: column;">
                <p style="margin: 0px; white-space: nowrap; text-overflow: ellipsis; overflow: hidden; width: 100%;">${this._escapeHtml(r.name)}</p>
    ...
    `}_createElement(){let e=document.createElement("div");return e.innerHTML=this._render(),e.firstElementChild}_rerender(){if(!this.element||!this.element.parentNode)return;let e=this.element.parentNode,t=this._createElement();e.replaceChild(t,this.element),this.element=t,this._bindEvents(),s.debug(`Componente re-renderizado: ${this.id}`)}_getLocationIdFromUrl(){let t=window.location.pathname.match(/\/location\/([^\/]+)/);return t?t[1]:null}_isAllowedLocation(){return this._getLocationIdFromUrl()===this.allowedLocationId}_handleToggle(e){e.target.closest('[data-action="clear"]')||(e.stopPropagation(),e.preventDefault(),this._justToggled=!0,setTimeout(()=>{this._justToggled=!1},100),this.setState({isOpen:!this.state.isOpen}))}_handleSelect(e){let t=e.target.closest(".hr-base-select-option");if(!t)return;let n=t.dataset.userId;if(!n)return;let i=this.state.users.find(r=>r.id===n);i&&(this.setState({selectedUser:i,isOpen:!1}),this.emit("user:selected",i),s.debug(`Usu\xE1rio selecionado: ${i.name}`))}_handleClickOutside(e){this._justToggled||this.element&&!this.element.contains(e.target)&&this.state.isOpen&&this.setState({isOpen:!1})}_handleClear(e){e.stopPropagation(),e.preventDefault(),this.setState({selectedUser:null,isOpen:!1}),this.emit("user:cleared",null),s.debug("Sele\xE7\xE3o limpa")}_bindEvents(){if(!this.element)return;let e=this.element.querySelector(".hr-base-selection"),t=this.element.querySelector(".hr-base-select-menu"),n=this.element.querySelector('[data-action="clear"]');e&&e.addEventListener("click",this._handleToggle),t&&t.addEventListener("click",this._handleSelect),n&&n.addEventListener("click",this._handleClear),document.removeEventListener("click",this._handleClickOutside),document.addEventListener("click",this._handleClickOutside)}_unbindEvents(){document.removeEventListener("click",this._handleClickOutside)}async mountReplacing(){try{if(!this._isAllowedLocation()){let e=this._getLocationIdFromUrl();return s.debug(`UserDropdown n\xE3o exibido: locationId atual (${e}) diferente do permitido (${this.allowedLocationId})`),null}return this.originalElement=await z(this.targetSelector,{timeout:1e4}),this.originalElement?(this.originalElement.style.display="none",this.element=this._createElement(),this.originalElement.parentNode.insertBefore(this.element,this.originalElement.nextSibling),this._mounted=!0,this._bindEvents(),s.debug(`UserDropdown montado substituindo: ${this.targetSelector}`),this.element):(s.error(`Elemento n\xE3o encontrado: ${this.targetSelector}`),null)}catch(e){return s.error(`Erro ao montar UserDropdown: ${e.message}`),null}}unmount(){this._unbindEvents(),this.element&&this.element.parentNode&&this.element.parentNode.removeChild(this.element),this.originalElement&&(this.originalElement.style.display="",s.debug("Elemento original restaurado")),this._mounted=!1}};var T={baseUrl:"https://services.leadconnectorhq.com",token:"pit-301590c6-a6cb-47d5-a7f4-bc5c4f5c22d4",version:"2021-07-28"};function pe(){return{Accept:"application/json","Content-Type":"application/json",Authorization:`Bearer ${T.token}`,Version:T.version}}async function Y(o){let e=`${T.baseUrl}/users/?locationId=${o}`,t=await fetch(e,{method:"GET",headers:pe()});if(!t.ok)throw new Error(`Erro ao buscar usu\xE1rios: ${t.status}`);return(await t.json()).users||[]}function E(){let e=window.location.pathname.match(/\/location\/([^\/]+)/);return e?e[1]:null}var j={baseUrl:"https://services.leadconnectorhq.com",token:"pit-301590c6-a6cb-47d5-a7f4-bc5c4f5c22d4",version:"2021-07-28"};async function K(o,e){let t=`${j.baseUrl}/opportunities/${o}`,n={Accept:"application/json","Content-Type":"application/json",Authorization:`Bearer ${j.token}`,Version:j.version},r=await fetch(t,{method:"PUT",headers:n,body:JSON.stringify({assignedTo:e})}),a=await r.json();return{ok:r.ok,status:r.status,data:a}}function he(){let e=window.location.pathname.match(/\/opportunities\/list\/([^\/\?]+)/);return e?e[1]:null}function me(){let o=document.querySelectorAll("span");for(let e of o)if(e.textContent?.includes("Registros de auditoria:")){let t=e.querySelector("span.cursor-pointer");if(t)return t.textContent?.trim()||null}return null}function X(){return me()||he()}var D=class{constructor(){this.host=null,this.shadowRoot=null,this.contentWrapper=null,this._initialized=!1}async init(){if(this._initialized)return s.warn("Container j\xE1 inicializado"),this.contentWrapper;await V();let e=c(),t=u();return this.host=$("div",{id:`${t}-host`,style:{all:"initial",position:"fixed",top:"0",left:"0",width:"0",height:"0",overflow:"visible",zIndex:e.zIndexBase.toString(),pointerEvents:"none"}}),e.cssIsolation==="shadow-dom"&&(this.shadowRoot=this.host.attachShadow({mode:"open"}),f.setShadowRoot(this.shadowRoot)),this.contentWrapper=$("div",{id:`${t}-content`,className:`${t}-root`,style:{all:"initial",display:"block"}}),(this.shadowRoot||this.host).appendChild(this.contentWrapper),f.injectBaseStyles(),this._mountToDOM(e),this._initialized=!0,s.debug("Container inicializado"),this.contentWrapper}_mountToDOM(e){let{mountTarget:t,mountPosition:n}=e;if(t){let i=document.querySelector(t);if(i){i.appendChild(this.host);return}s.warn(`Target "${t}" n\xE3o encontrado, usando body`)}n==="body-start"?document.body.insertBefore(this.host,document.body.firstChild):document.body.appendChild(this.host)}getContentRoot(){if(!this._initialized)throw new Error("Container n\xE3o inicializado. Chame init() primeiro.");return this.contentWrapper}getShadowRoot(){return this.shadowRoot}isInitialized(){return this._initialized}destroy(){this._initialized&&(f.clear(),this.host&&this.host.parentNode&&this.host.parentNode.removeChild(this.host),this.host=null,this.shadowRoot=null,this.contentWrapper=null,this._initialized=!1,s.debug("Container destru\xEDdo"))}},g=new D;var h={initialized:!1,destroyed:!1};async function _(o,...e){let n=c().hooks[o];if(typeof n=="function")try{await n(...e),s.debug(`Hook executado: ${o}`)}catch(i){s.error(`Erro no hook ${o}:`,i)}}async function N(o={}){if(h.initialized)return s.warn("Aplica\xE7\xE3o j\xE1 inicializada"),ee();try{O(o);let e=c();return s.debug("Iniciando aplica\xE7\xE3o",e),await _("onBeforeInit"),await g.init(),p.emit("app:init",{config:e}),await _("onAfterInit"),h.initialized=!0,h.destroyed=!1,s.info("Aplica\xE7\xE3o inicializada com sucesso"),ee()}catch(e){throw s.error("Falha na inicializa\xE7\xE3o:",e),await _("onError",e),e}}async function te(){if(!(!h.initialized||h.destroyed))try{await _("onBeforeDestroy"),p.emit("app:destroy"),p.clear(),g.destroy(),await _("onAfterDestroy"),h.initialized=!1,h.destroyed=!0,s.info("Aplica\xE7\xE3o destru\xEDda")}catch(o){s.error("Erro ao destruir aplica\xE7\xE3o:",o)}}function ee(){return{isInitialized:()=>h.initialized,getContainer:()=>g.getContentRoot(),getShadowRoot:()=>g.getShadowRoot(),on:(o,e)=>p.on(o,e),off:(o,e)=>p.off(o,e),emit:(o,e)=>p.emit(o,e),getConfig:c,setConfig:O,destroy:te}}var x="citQs4acsN1StzOEDuvj",b="#OpportunityOwner",q='[data-component-id^="user-dropdown"]',C=null,M=!1,B=!1,U=null,F=null,S=null;function oe(){return E()===x&&!S&&(l.debug("Prefetch de usu\xE1rios iniciado..."),S=Y(x).then(e=>(F=e,l.info(e.length+" usu\xE1rios pr\xE9-carregados"),e)).catch(e=>(l.error("Erro no prefetch: "+e.message),S=null,[]))),S}function fe(){return!!document.querySelector(q)}function ge(){document.querySelectorAll(q).forEach(e=>e.remove());let o=document.querySelector(b);o&&(o.style.display="")}function W(){return C}async function w(){try{l.info("Iniciando Switch User...");let o=E();if(o!==x){l.debug("Location n\xE3o permitida: "+o);return}N({debug:!0,namespace:"ui-injector"});let e=F?Promise.resolve(F):S||oe(),t=(async()=>{let r=document.querySelector(b),a=0;for(;!r&&a<100;)await new Promise(d=>setTimeout(d,50)),r=document.querySelector(b),a++;return r})(),[n,i]=await Promise.all([e,t]);if(!i){l.error(`Elemento ${b} n\xE3o encontrado`);return}document.querySelectorAll(q).forEach(r=>r.remove()),i.style.display="",C=new y({users:n,targetSelector:b,allowedLocationId:x}),C.on("user:selected",async r=>{let a=X();if(!a){l.error("Opportunity ID n\xE3o encontrado");return}l.info("Atualizando owner para: "+r.name);try{let d=await K(a,r.id);d.ok?l.info("Owner atualizado com sucesso"):l.error("Falha ao atualizar: "+JSON.stringify(d.data))}catch(d){l.error("Erro ao atualizar owner: "+d.message)}}),await C.mountReplacing(),l.info("Dropdown montado com "+n.length+" usu\xE1rios")}catch(o){l.error("Erro: "+o.message),console.error(o)}}async function be(){M=!0;try{await w()}finally{M=!1,B&&(B=!1,P())}}function xe(){if(M){B=!0;return}be()}function P(){if(E()!==x)return;let e=document.querySelector(b),t=fe();e&&!t?(l.debug("Elemento #OpportunityOwner detectado, injetando dropdown..."),xe()):!e&&t&&(l.debug("Elemento #OpportunityOwner removido, limpando dropdown..."),ge())}function we(){if(U)return;if(E()!==x){l.debug("Location n\xE3o permitida, n\xE3o iniciando observer");return}l.debug("Iniciando MutationObserver para detectar #OpportunityOwner..."),U=new MutationObserver(()=>{P()}),U.observe(document.body,{childList:!0,subtree:!0}),P()}typeof window<"u"&&(window.UIInjector={start:w,init:w,getDropdown:W},oe(),we());var ve={start:w,init:w,getDropdown:W};return ce(ye);})();
